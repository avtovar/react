import{$ as e,J as t,Lt as n,Z as r,pt as i,tt as a,yt as o}from"./chunks/framework.BTiPPQh6.js";var s=`<svg viewBox="0 0 1896 1071" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,l=JSON.parse(`{"title":"Why Vite","description":"","frontmatter":{},"headers":[],"relativePath":"guide/why.md","filePath":"guide/why.md"}`),u=Object.assign({name:`guide/why.md`},{setup(l){return(l,u)=>{let d=o(`svg-image`);return i(),r(`div`,null,[u[0]||=e("",10),a(d,{svg:n(s)},null,8,[`svg`]),u[1]||=t(`p`,null,[t(`em`,null,`In a bundle-based dev server, the entire application is bundled before it can be served.`)],-1),a(d,{svg:n(c)},null,8,[`svg`]),u[2]||=e("",14)])}}});export{l as __pageData,u as default};