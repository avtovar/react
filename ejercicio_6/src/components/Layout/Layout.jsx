...
// ↑ Importa el "Directorio": el componente que carga los creadores del
//   sitio desde nosotros.json y muestra sus tarjetas (va en el footer).
    ...
    <div className="layout">
      <header className="header">
        ...
        <div className="container header__contenido">
          ...
          <nav className="nav" aria-label="Navegación principal">
            ...
            <a className="nav__enlace" href="#nuevo-producto">
              Cargar producto
            </a>
            <a className="nav__enlace" href="#equipo">
              Equipo
            </a>
      ...
      <footer className="footer">
        {/* ↑ Pie de página: se mantiene abajo porque .main tiene flex: 1.
             Acá adentro va el Directorio del equipo, al principio del footer
             (como pide el ejercicio), y después el texto de copyright. */}
        <div className="container">
          <Directorio />
          {/* ↑ El Directorio muestra "Cargando equipo...", un error, o la
               grilla de tarjetas de contacto con los creadores del sitio. */}
        </div>
        ...
        <div className="container footer__contenido">
          ...
          <p className="footer__texto">
            Hecho con React, useEffect y fetch para el ejercicio de TalentoLab
          </p>
        </div>
      </footer>
    </div>
