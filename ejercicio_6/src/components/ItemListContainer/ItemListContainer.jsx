...
function ItemListContainer({ mensaje }) {
  ...
  const productos = [
    ...
    //   La imagen apunta a un archivo LOCAL (public/images/productos),
    //   fotos reales de cada producto para que la tienda se vea mejor.
    {
      id: 1,
    ...
    },
    {
      ...
      precio: 179999,
      stock: 8,
      imagen: '/images/productos/smartwatch.jpg',
    },
    {
      id: 3,
      ...
      precio: 89999,
      stock: 20,
      imagen: '/images/productos/parlante.jpg',
    },
    {
      id: 4,
      ...
      precio: 119999,
      stock: 15,
      imagen: '/images/productos/teclado.jpg',
    },
  ]
